...
public class ReviewDataTransformer {
  ...
  public Review transform(RawReviewData rawData, Provider provider) {
    try {
      log.debug(
          "Transforming raw review data for hotel ID: {}, provider: {}",
          rawData.getHotelId(),
          provider.getName());
      ...
      log.debug(
          "Successfully transformed review with ID: {} for hotel: {}",
          review.getProviderExternalId(),
          review.getHotelName());
      ...
      log.error(
          "Error transforming raw review data for hotel ID: {}, provider: {}",
          rawData.getHotelId(),
          provider.getName(),
          e);
