...
public interface ProcessedFileRepository {
     ...
     */
    List<ProcessedFile> findOldProcessedFiles(LocalDateTime cutoffDate, List<ProcessingStatus> statuses);
     ...
     */
    List<ProcessedFile> findRecentlyProcessedFiles(String provider, LocalDateTime since, ProcessingStatus status);
     ...
     */
    int deleteByCreatedAtBeforeAndProcessingStatusIn(LocalDateTime cutoffDate, List<ProcessingStatus> statuses);
