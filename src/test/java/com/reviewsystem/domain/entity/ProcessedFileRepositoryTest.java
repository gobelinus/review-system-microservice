...
class ProcessedFileRepositoryTest {
    ...
    void setUp() {
        ...
        sampleFile1 = ProcessedFile.builder()
        ...
        sampleFile2 = ProcessedFile.builder()
        ...
        sampleFile3 = ProcessedFile.builder()
    ...
    class BasicCrudOperationsTests {
        ...
        void shouldFindAllProcessedFiles() {
            ...
            assertThat(allFiles).extracting(ProcessedFile::getprovider)
    ...
    class FindByS3KeyAndETagTests {
        ...
        void shouldFindFileByS3KeyAndETag() {
            ...
            Optional<ProcessedFile> result = processedFileRepository.findByS3KeyAndEtag(
        ...
        void shouldReturnEmptyWhenS3KeyAndETagCombinationDoesNotExist() {
            ...
            Optional<ProcessedFile> result = processedFileRepository.findByS3KeyAndEtag(
                    "non-existent-key", "non-existent-etag");
        ...
        void shouldReturnEmptyWhenS3KeyExistsButETagIsDifferent() {
            ...
            Optional<ProcessedFile> result = processedFileRepository.findByS3KeyAndEtag(
                    sampleFile1.getS3Key(), "different-etag");
        ...
        void shouldCheckExistenceByS3KeyAndETag() {
            ...
            boolean exists = processedFileRepository.existsByS3KeyAndEtag(
                    sampleFile1.getS3Key(), sampleFile1.getEtag());
            boolean notExists = processedFileRepository.existsByS3KeyAndEtag(
                    "non-existent-key", "non-existent-etag");
    ...
    class FindByProcessingStatusTests {
        ...
        void shouldFindFilesByProcessingStatus() {
            ...
            List<ProcessedFile> completedFiles = processedFileRepository.findByProcessingStatus(ProcessingStatus.COMPLETED);
            List<ProcessedFile> failedFiles = processedFileRepository.findByProcessingStatus(ProcessingStatus.FAILED);
            List<ProcessedFile> processingFiles = processedFileRepository.findByProcessingStatus(ProcessingStatus.PROCESSING);
        ...
        void shouldReturnEmptyListWhenNoFilesMatchProcessingStatus() {
            ...
            List<ProcessedFile> pendingFiles = processedFileRepository.findByProcessingStatus(ProcessingStatus.PENDING);
        ...
        void shouldFindFilesByproviderAndProcessingStatus() {
            ProcessedFile agodaCompleted = sampleFile1.toBuilder().build();
            ProcessedFile agodaFailed = ProcessedFile.builder()
            ...
            List<ProcessedFile> agodaCompletedFiles = processedFileRepository
                    .findByproviderAndProcessingStatus("agoda", ProcessingStatus.COMPLETED);
            List<ProcessedFile> agodaFailedFiles = processedFileRepository
                    .findByproviderAndProcessingStatus("agoda", ProcessingStatus.FAILED);
        ...
        void shouldCountFilesByProcessingStatus() {
            ...
            long completedCount = processedFileRepository.countByProcessingStatus(ProcessingStatus.COMPLETED);
            long failedCount = processedFileRepository.countByProcessingStatus(ProcessingStatus.FAILED);
            long processingCount = processedFileRepository.countByProcessingStatus(ProcessingStatus.PROCESSING);
        ...
        void shouldCountFilesByproviderAndProcessingStatus() {
            ...
            long agodaCompletedCount = processedFileRepository
                    .countByproviderAndProcessingStatus("agoda", ProcessingStatus.COMPLETED);
            long agodaFailedCount = processedFileRepository
                    .countByproviderAndProcessingStatus("agoda", ProcessingStatus.FAILED);
            long bookingFailedCount = processedFileRepository
                    .countByproviderAndProcessingStatus("booking", ProcessingStatus.FAILED);
    ...
    class DateBasedQueryTests {
        ...
        void shouldFindFilesCreatedAfterSpecificDate() {
            ...
            assertThat(recentFiles).extracting(ProcessedFile::getprovider)
        ...
        void shouldFindOldProcessedFilesForCleanup() {
            ...
            List<ProcessedFile> oldFiles = processedFileRepository
                    .findOldProcessedFiles(cutoffDate, terminalStatuses);

            assertThat(oldFiles).hasSize(2);
            assertThat(oldFiles).extracting(ProcessedFile::getprovider)
        ...
        void shouldFindStuckProcessingFiles() {
            ...
            sampleFile1.setProcessingStatus(ProcessingStatus.PROCESSING);
            sampleFile1.setProcessingStartedAt(LocalDateTime.now().minusHours(3));

            // Create recent processing file (should not be included)
            sampleFile2.setProcessingStatus(ProcessingStatus.PROCESSING);
            ...
            List<ProcessedFile> stuckFiles = processedFileRepository
                    .findStuckProcessingFiles(cutoffDateTime);
        ...
        void shouldFindRecentlyProcessedFiles() {
            ...
            List<ProcessedFile> recentFiles = processedFileRepository
                    .findRecentlyProcessedFiles("agoda", since, ProcessingStatus.COMPLETED);
    ...
    class DeleteOperationsTests {
        ...
        void shouldDeleteOldRecordsByDateAndStatus() {
            ...
            int deletedCount = processedFileRepository
                    .deleteByCreatedAtBeforeAndProcessingStatusIn(cutoffDate, terminalStatuses);
    ...
    class ConstraintAndValidationTests {
        ...
        void shouldEnforceUniqueConstraintOnS3KeyAndEtagCombination() {
            ProcessedFile file1 = sampleFile1.toBuilder().build();
            ProcessedFile file2 = ProcessedFile.builder()
